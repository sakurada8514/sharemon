...
class S3ImageModel extends BaseModel
{
    ...
    public function insert(string $_imgUrl, Authenticatable $_user, ?string $_expense_id = null)
    {
    ...
    private function _createS3ImgInsertData(string $_imgUrl, Authenticatable $_user, ?string $_expense_id = null)
    {
        return [
